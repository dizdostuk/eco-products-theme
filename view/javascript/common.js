...
$(document).ready(function() {
	...
	$('i#minus-qty').click(function(){
		...
		if(crtval < 2){
			...
			$.ajax('index.php?route=checkout/cart/edit', {
				quantity: {
					product: crtval
				}
			});
...
var cart = {
	'add': function(product_id, quantity) {
		$.ajax({
			...
			type: 'post',
			data: 'product_id=' + product_id + '&quantity=' + (typeof(quantity) != 'undefined' ? quantity : $('#cart_quantity_'+product_id).val()),
			dataType: 'json',
			complete: function() {
				$('#cart > a').button('reset');
			},
	...
	'increment': function(product_id) {
		let inpt = $('#cart_quantity_'+product_id);
